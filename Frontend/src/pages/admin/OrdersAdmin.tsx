  ...
  return (
    <div className="w-full">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">Monitor and manage orders</p>
      </div>
      ...
      {loading ? (
        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
          <div className="size-3 rounded-full border-2 border-gray-300 border-t-indigo-600 animate-spin" /> Loading orders...
        </div>
      ) : (
